...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://super-app-portal.preview.emergentagent.com')
...
class TestStripeCheckout:
    ...
    def test_checkout_without_auth_returns_401(self):
        ...
        response = requests.post(f"{BASE_URL}/api/stripe/checkout", json={
            "package_id": "50",
            "origin_url": "https://super-app-portal.preview.emergentagent.com"
        })
