...
async def create_auction(auction: AuctionCreate, admin: dict = Depends(get_admin_user)):
    ...
    # MINIMUM DURATION: 5 minutes (300 seconds) - reduced for testing purposes
    ...
    if auction.start_time and auction.end_time:
        ...
        if (end_time - start_time).total_seconds() < MIN_DURATION_SECONDS:
    ...
    # Store actual duration in seconds
    ...
    doc = {
        ...
        "is_free_auction": auction.is_free_auction or False,
