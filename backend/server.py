...
from routers.bidblitz_dashboard import router as dashboard_router

# NEW: BidBlitz AI Analytics
from routers.bidblitz_ai import router as ai_router
...
app.include_router(vip_loyalty_router, prefix="/api")
...
app.include_router(partner_transfer_router, prefix="/api")
    ...
    while bot_task_running:
        try:
            ...
            for auction in active_auctions:
                ...
                # Skip if we bid recently (15-45 seconds for natural slow bidding)
                last_bid = last_bid_time.get(auction_id, 0)
                min_interval = random.uniform(15, 45)  # Langsames, natürliches Intervall
            ...
            # Wait before next cycle (8-20 seconds for slow, natural bidding)
