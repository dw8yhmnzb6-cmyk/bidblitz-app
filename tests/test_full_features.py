...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://bidblitz-admin.preview.emergentagent.com').rstrip('/')
...
class TestBidPackages:
    ...
    def test_checkout_session_creation(self):
        ...
        response = requests.post(
            ...
            json={
                "package_id": "pack_25",
                "origin_url": "https://bidblitz-admin.preview.emergentagent.com"
            },
