...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            print("-" * 80)
            await page.goto("https://kyc-approval-hub.preview.emergentagent.com/auth", wait_until="networkidle", timeout=30000)
            ...
            for name, path in unsafe_paths.items():
                try:
                    await page.goto(f"https://kyc-approval-hub.preview.emergentagent.com{path}", wait_until="networkidle", timeout=10000)
            ...
            await page.goto("https://kyc-approval-hub.preview.emergentagent.com/more", wait_until="networkidle", timeout=10000)
            await page.wait_for_timeout(2000)
            ...
            await page.goto("https://kyc-approval-hub.preview.emergentagent.com/wallet", wait_until="networkidle", timeout=10000)
            await page.wait_for_timeout(2000)
            ...
            await page.goto("https://kyc-approval-hub.preview.emergentagent.com/home", wait_until="networkidle", timeout=10000)
            await page.wait_for_timeout(2000)
