...
import TaxiQuickDestinations from "./TaxiQuickDestinations";
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <TaxiSavedPlacesRow
          ...
          onPick={(p) => setDropoff({ lat: p.lat, lng: p.lng, address: p.address })}
        />

        <TaxiQuickDestinations
          hasDropoff={Boolean(dropoff.address && dropoff.lat !== 0)}
