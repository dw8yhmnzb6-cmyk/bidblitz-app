...
// Professional vehicle SVG icons (Uber/Bolt-style silhouettes). Extracted from TaxiPage.jsx (iter57c).
export const VehicleIcon = ({ type, className = '', active = false }) => {
  ...
  // Standard – compact hatchback/sedan
  return (
    <svg viewBox="0 0 64 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
