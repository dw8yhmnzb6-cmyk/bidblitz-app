    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">{t('adCreated')}</h2>
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="sticky top-0 z-50 bg-slate-900/90 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-bold text-white">{t('createTitle')}</h1>
            <div className="w-20" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Title */}
          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
            <label className="block text-white font-semibold mb-2">{t('titleField')} *</label>
            <input
              type="text"
          ...
          {/* Description */}
          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
            <label className="block text-white font-semibold mb-2">{t('descriptionField')} *</label>
            <textarea
          ...
          <div className="bg-gradient-to-r from-yellow-600/20 to-amber-600/20 rounded-xl p-4 border border-yellow-500/30">
            <label className="flex items-center justify-between cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold">{t('premiumAd')}</p>
                  <p className="text-slate-400 text-sm">{t('moreVisibility')}</p>
                </div>
              </div>
              <input
                type="checkbox"
