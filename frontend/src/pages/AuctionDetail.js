...
import { Timer, Users, Zap, ArrowLeft, Trophy, Tag, Package } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-6 rounded-xl space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#94A3B8] text-sm">Kategorie</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#94A3B8] text-sm">UVP</p>
          ...
          <div className="space-y-6">
            ...
            <div className={`glass-card p-6 rounded-xl ${isUrgent && !isEnded ? 'glow-urgency' : ''}`}>
              ...
              {isEnded ? (
                <p className="text-3xl font-bold text-[#EF4444] font-mono">AUKTION BEENDET</p>
              ) : (
            ...
            <div className="glass-card p-6 rounded-xl space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#94A3B8] text-sm uppercase tracking-wider mb-1">Aktueller Preis</p>
              ...
              {auction.last_bidder_name && (
                <div className="flex items-center justify-between p-3 rounded-lg bg-[#181824]">
                  <span className="text-[#94A3B8]">Letzter Bieter:</span>
              ...
              {!isAuthenticated && (
                <p className="text-center text-[#94A3B8] text-sm">
                  <Link to="/login" className="text-[#7C3AED] hover:underline">Anmelden</Link> um zu bieten
                </p>
              )}
            </div>
          </div>
