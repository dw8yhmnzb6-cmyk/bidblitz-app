    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-all duration-300 group">
      ...
      <div className="p-3">
        ...
        <div className="flex gap-3 items-end">
          {/* Product Image */}
          <div className="w-16 h-16 flex-shrink-0 flex items-center justify-center bg-white rounded-lg overflow-hidden border border-gray-100">
            <img
          ...
          <Link to={`/auctions/${auction.id}`} className="flex-1">
            <button 
              ...
              className={`w-full font-bold py-2.5 px-3 rounded-lg text-xs uppercase transition-all ${
                isEnded 
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Auctions Grid - Responsive columns */}
        <div className="grid grid-cols-1 min-[400px]:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
