    ...
    <div className="min-h-screen bg-[#050505] text-white px-5 py-8" data-testid="icharging-entry-page">
      <div className="mx-auto max-w-lg space-y-6">
        ...
        <div className="rounded-3xl border border-cyan-400/20 bg-gradient-to-br from-cyan-500/15 via-[#111] to-fuchsia-500/10 p-6 shadow-2xl">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-cyan-300">iCharging · Bezahlung mit BidBlitz</p>
          <h1 className="mt-3 text-3xl font-black tracking-tight">Elektrisch durch deine Stadt.</h1>
          <p className="mt-3 text-sm leading-6 text-gray-300">iCharging vermietet elektrische Fahrzeuge. Für Registrierung und Bezahlung nutzen wir den sicheren BidBlitz-Zahlungsdienst.</p>
        ...
        <p className="text-center text-[11px] leading-5 text-gray-500">iCharging ist ein eigenständiger Mobilitätsanbieter. BidBlitz stellt ausschließlich Anmeldung, Wallet und Bezahlung bereit.</p>
      </div>
    </div>
  );
}
