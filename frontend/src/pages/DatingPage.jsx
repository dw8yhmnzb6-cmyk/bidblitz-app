...
export default function DatingPage({ onBack }) {
  ...
  const [monetization, setMonetization] = useState({ entitlements: {}, starter_offer: null, limited_bundle_offer: null, experiments: {}, likes_you_count: 0, profile_completion: 0 });
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [profileRes, discoverRes, matchesRes, swipeRes, likesRes, nearbyRes, crossedRes, plansRes, monetizationRes, topPicksRes, standoutsRes] = await Promise.all([
        ...
        api("/api/dating/monetization").catch(() => ({ consumables: defaultConsumables, entitlements: {}, starter_offer: null, limited_bundle_offer: null, experiments: {}, likes_you_count: 0, profile_completion: 0 })),
