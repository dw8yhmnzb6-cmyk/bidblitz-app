...
import { 
  ...
  Trash2, ToggleLeft, ToggleRight, Eye, EyeOff, Clock, Sparkles, Mail, Pencil, Save
} from 'lucide-react';
...
const enterpriseTranslations = {
  de: {
    ...
    taxAdvisorDesc: 'Nur Zugriff auf Berichte und Exporte',
    active: 'Aktiv',
    inactive: 'Inaktiv',
    export: 'Exportieren',
    ...
    monthly: 'Monatlich',
    manual: 'Manuell',
    ibanSelfEntry: 'IBAN vom Großhändler eingeben lassen',
    ibanAdminEntry: 'IBAN von Admin verwalten',
  ...
  en: {
    ...
    taxAdvisorDesc: 'Access to reports and exports only',
    ...
    monthly: 'Monthly',
    manual: 'Manual',
    ibanSelfEntry: 'Let wholesaler enter IBAN',
    ibanAdminEntry: 'Admin manages IBAN',
    ...
    voucherCommission: 'Voucher Commission',
    selfPayCommission: 'Self-Pay Commission',
  ...
  ar: {
    ...
    cashier: 'كاشير',
    taxAdvisor: 'مستشار ضريبي',
    taxAdvisorDesc: 'الوصول للتقارير والتصدير فقط',
    active: 'نشط',
    inactive: 'غير نشط',
    export: 'تصدير',
    csvExport: 'تصدير CSV',
    ...
    ibanHolder: 'صاحب الحساب',
    payoutFrequency: 'تكرار الدفع',
    daily: 'يومي',
    weekly: 'أسبوعي',
    monthly: 'شهري',
    manual: 'يدوي',
    ibanSelfEntry: 'إدخال IBAN من قبل التاجر',
    ibanAdminEntry: 'إدارة IBAN من قبل المسؤول',
  ...
  tr: {
    ...
    cashier: 'Kasiyer',
    taxAdvisor: 'Vergi Danışmanı',
    taxAdvisorDesc: 'Sadece raporlara ve dışa aktarmaya erişim',
    active: 'Aktif',
    inactive: 'Pasif',
    export: 'Dışa Aktar',
    csvExport: 'CSV İndir',
    ...
    iban: 'IBAN',
    ibanHolder: 'Hesap Sahibi',
    payoutFrequency: 'Ödeme Sıklığı',
    daily: 'Günlük',
    weekly: 'Haftalık',
    monthly: 'Aylık',
    manual: 'Manuel',
    ibanSelfEntry: 'Bayi IBAN girsin',
    ibanAdminEntry: 'Admin IBAN yönetsin',
    minPayout: 'Minimum Ödeme Tutarı',
    pendingPayout: 'Bekleyen Ödeme',
    lastPayout: 'Son Ödeme',
    payoutHistory: 'Ödeme Geçmişi',
    staffName: 'Çalışan Adı',
  ...
  fr: {
    ...
    subtitle: 'Gérez vos filiales, caisses et rapports',
    login: 'Connexion',
    register: "S'inscrire",
    email: 'E-mail',
    ...
    newKey: 'Nouvelle caisse',
    newUser: 'Nouvel employé',
    branchName: 'Nom de la filiale',
    city: 'Ville',
    managerName: 'Nom du gérant',
    managerEmail: 'E-mail du gérant',
    registerName: 'Nom de la caisse',
    selectBranch: 'Sélectionner une filiale',
    role: 'Rôle',
    admin: 'Administrateur',
    branchManager: 'Gérant de filiale',
    cashier: 'Caissier',
    taxAdvisor: 'Conseiller fiscal',
    taxAdvisorDesc: 'Accès aux rapports et exports uniquement',
    active: 'Actif',
    inactive: 'Inactif',
    export: 'Exporter',
    ...
    registrationSuccess: 'Inscription réussie! Votre compte est en cours de vérification.',
    allBranches: 'Toutes les filiales',
    recentTransactions: 'Transactions récentes',
    branchComparison: 'Comparaison des filiales',
    topBranches: 'Meilleures filiales',
    payoutSettings: 'Paramètres de paiement',
    iban: 'IBAN',
    ibanHolder: 'Titulaire du compte',
    payoutFrequency: 'Fréquence de paiement',
    daily: 'Quotidien',
    weekly: 'Hebdomadaire',
    monthly: 'Mensuel',
    manual: 'Manuel',
  ...
  // Spanish
  es: {
    title: 'Portal de Comerciantes',
    subtitle: 'Gestiona tus sucursales, cajas y informes',
    ...
    registerName: 'Nombre de caja',
    selectBranch: 'Seleccionar sucursal',
    role: 'Rol',
    admin: 'Administrador',
    branchManager: 'Gerente de sucursal',
    cashier: 'Cajero',
    taxAdvisor: 'Asesor fiscal',
    taxAdvisorDesc: 'Solo acceso a informes y exportaciones',
    active: 'Activo',
    inactive: 'Inactivo',
    export: 'Exportar',
    ...
    registrationSuccess: '¡Registro exitoso! Tu cuenta está siendo verificada.',
    allBranches: 'Todas las sucursales',
    recentTransactions: 'Transacciones recientes',
    branchComparison: 'Comparación de sucursales',
    topBranches: 'Mejores sucursales',
    payoutSettings: 'Configuración de pagos',
    iban: 'IBAN',
    ibanHolder: 'Titular de la cuenta',
  ...
  // Italian
  it: {
    title: 'Portale Commerciante',
    subtitle: 'Gestisci le tue filiali, casse e report',
    login: 'Accedi',
    register: 'Registrati',
    email: 'E-mail',
    password: 'Password',
    ...
    newKey: 'Nuova cassa',
    newUser: 'Nuovo dipendente',
    branchName: 'Nome filiale',
    city: 'Città',
    managerName: 'Nome responsabile',
    managerEmail: 'Email responsabile',
    registerName: 'Nome cassa',
    selectBranch: 'Seleziona filiale',
    role: 'Ruolo',
    admin: 'Amministratore',
    branchManager: 'Responsabile filiale',
    cashier: 'Cassiere',
    taxAdvisor: 'Consulente fiscale',
    taxAdvisorDesc: 'Solo accesso a report ed export',
    active: 'Attivo',
    inactive: 'Inattivo',
    export: 'Esporta',
    ...
    registrationSuccess: 'Registrazione completata! Il tuo account è in verifica.',
    allBranches: 'Tutte le filiali',
    recentTransactions: 'Transazioni recenti',
    branchComparison: 'Confronto filiali',
    topBranches: 'Migliori filiali',
    payoutSettings: 'Impostazioni pagamento',
    iban: 'IBAN',
    ibanHolder: 'Intestatario conto',
    payoutFrequency: 'Frequenza pagamento',
    daily: 'Giornaliero',
    weekly: 'Settimanale',
    monthly: 'Mensile',
    manual: 'Manuale',
    ...
    commissionSettings: 'Impostazioni commissioni',
  },
  // Polish
  pl: {
    title: 'Portal Handlowca',
    subtitle: 'Zarządzaj swoimi oddziałami, kasami i raportami',
    login: 'Zaloguj się',
    ...
    bonus: 'Bonus',
    cashback: 'Cashback',
    newBranch: 'Nowy oddział',
    newKey: 'Nowa kasa',
    newUser: 'Nowy pracownik',
    branchName: 'Nazwa oddziału',
    city: 'Miasto',
    managerName: 'Imię kierownika',
    managerEmail: 'Email kierownika',
    registerName: 'Nazwa kasy',
    selectBranch: 'Wybierz oddział',
    role: 'Rola',
    admin: 'Administrator',
    branchManager: 'Kierownik oddziału',
    cashier: 'Kasjer',
    taxAdvisor: 'Doradca podatkowy',
    taxAdvisorDesc: 'Tylko dostęp do raportów i eksportów',
    active: 'Aktywny',
    inactive: 'Nieaktywny',
    export: 'Eksportuj',
    ...
    noData: 'Brak danych',
    registrationSuccess: 'Rejestracja udana! Twoje konto jest weryfikowane.',
    allBranches: 'Wszystkie oddziały',
    recentTransactions: 'Ostatnie transakcje',
    branchComparison: 'Porównanie oddziałów',
    topBranches: 'Najlepsze oddziały',
    payoutSettings: 'Ustawienia wypłat',
    iban: 'IBAN',
    ibanHolder: 'Właściciel konta',
    payoutFrequency: 'Częstotliwość wypłat',
    daily: 'Codziennie',
    weekly: 'Co tydzień',
    monthly: 'Co miesiąc',
    manual: 'Ręcznie',
    connectionError: 'Błąd połączenia',
    savingError: 'Błąd podczas zapisywania',
    loadingError: 'Błąd ładowania',
    staffName: 'Imię pracownika',
    commissionSettings: 'Ustawienia prowizji',
  },
  // Russian
  ru: {
    title: 'Портал продавца',
    subtitle: 'Управляйте филиалами, кассами и отчетами',
    login: 'Войти',
    ...
    registerName: 'Название кассы',
    selectBranch: 'Выберите филиал',
    role: 'Роль',
    admin: 'Администратор',
    branchManager: 'Менеджер филиала',
    cashier: 'Кассир',
    taxAdvisor: 'Налоговый консультант',
    taxAdvisorDesc: 'Только доступ к отчетам и экспорту',
    active: 'Активен',
    inactive: 'Неактивен',
    export: 'Экспорт',
    ...
    noData: 'Нет данных',
    registrationSuccess: 'Регистрация успешна! Ваш аккаунт проверяется.',
    allBranches: 'Все филиалы',
    recentTransactions: 'Последние транзакции',
    branchComparison: 'Сравнение филиалов',
    topBranches: 'Лучшие филиалы',
    payoutSettings: 'Настройки выплат',
    iban: 'IBAN',
    ibanHolder: 'Владелец счета',
  ...
  zh: {
    ...
    deactivate: '停用',
    noData: '暂无数据',
    registrationSuccess: '注册成功！您的账户正在审核中。',
    allBranches: '所有分店',
    recentTransactions: '最近交易',
    branchComparison: '分店对比',
    topBranches: '热门分店',
    payoutSettings: '付款设置',
    iban: 'IBAN',
    ibanHolder: '账户持有人',
    payoutFrequency: '付款频率',
    daily: '每日',
    weekly: '每周',
    monthly: '每月',
    manual: '手动',
  ...
  pt: {
    ...
    subtitle: 'Gerencie suas filiais, caixas e relatórios',
    login: 'Entrar',
    register: 'Registrar',
    email: 'E-mail',
    password: 'Senha',
    ...
    registrationSuccess: 'Registro bem-sucedido! Sua conta está sendo verificada.',
    allBranches: 'Todas as filiais',
    recentTransactions: 'Transações recentes',
    branchComparison: 'Comparação de filiais',
    topBranches: 'Melhores filiais',
    payoutSettings: 'Configurações de pagamento',
    iban: 'IBAN',
    ibanHolder: 'Titular da conta',
  ...
  // Dutch
  nl: {
    title: 'Handelaarportaal',
    subtitle: 'Beheer uw filialen, kassa\'s en rapporten',
    login: 'Inloggen',
    ...
    bonus: 'Bonus',
    cashback: 'Cashback',
    newBranch: 'Nieuw filiaal',
    newKey: 'Nieuwe kassa',
    newUser: 'Nieuwe medewerker',
    branchName: 'Filiaalnaam',
    city: 'Stad',
    managerName: 'Naam manager',
    ...
    taxAdvisor: 'Belastingadviseur',
    taxAdvisorDesc: 'Alleen toegang tot rapporten en exports',
    active: 'Actief',
    inactive: 'Inactief',
    export: 'Exporteren',
    csvExport: 'CSV Export',
    ...
    registrationSuccess: 'Registratie succesvol! Uw account wordt geverifieerd.',
    allBranches: 'Alle filialen',
    recentTransactions: 'Recente transacties',
    branchComparison: 'Filiaalvergelijking',
    topBranches: 'Top filialen',
    payoutSettings: 'Uitbetalingsinstellingen',
    iban: 'IBAN',
    ibanHolder: 'Rekeninghouder',
    payoutFrequency: 'Uitbetalingsfrequentie',
    daily: 'Dagelijks',
    weekly: 'Wekelijks',
    monthly: 'Maandelijks',
    manual: 'Handmatig',
    ...
    commissionSettings: 'Commissie-instellingen',
  },
  // Albanian (Kosovo/Albania)
  sq: {
    title: 'Portali i Tregtarit',
    subtitle: 'Menaxhoni degët, arkat dhe raportet tuaja',
    login: 'Hyrje',
    ...
    newBranch: 'Degë e re',
    newKey: 'Arkë e re',
    newUser: 'Punonjës i ri',
    branchName: 'Emri i degës',
    city: 'Qyteti',
    managerName: 'Emri i menaxherit',
    managerEmail: 'Email i menaxherit',
    registerName: 'Emri i arkës',
    selectBranch: 'Zgjidhni degën',
    role: 'Roli',
    admin: 'Administrator',
    branchManager: 'Menaxher dege',
    cashier: 'Arkëtar',
    taxAdvisor: 'Këshilltar tatimor',
    taxAdvisorDesc: 'Vetëm qasje në raporte dhe eksporte',
    active: 'Aktiv',
    inactive: 'Joaktiv',
    export: 'Eksporto',
    csvExport: 'Eksport CSV',
    ...
    registrationSuccess: 'Regjistrimi i suksesshëm! Llogaria juaj po verifikohet.',
    allBranches: 'Të gjitha degët',
    recentTransactions: 'Transaksionet e fundit',
    branchComparison: 'Krahasimi i degëve',
    topBranches: 'Degët më të mira',
    payoutSettings: 'Cilësimet e pagesës',
    iban: 'IBAN',
    ibanHolder: 'Mbajtësi i llogarisë',
    payoutFrequency: 'Frekuenca e pagesës',
    daily: 'Ditore',
    weekly: 'Javore',
    monthly: 'Mujore',
    manual: 'Manuale',
    connectionError: 'Gabim lidhje',
    savingError: 'Gabim gjatë ruajtjes',
    loadingError: 'Gabim gjatë ngarkimit',
    staffName: 'Emri i punonjësit',
    commissionSettings: 'Cilësimet e komisionit',
  }
};

// Language options - All languages supported
const languages = [
