          ...
          <>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <motion.div className="flex items-baseline gap-1 mb-3 min-w-0 overflow-hidden" initial={{ opacity: 0, y: 10, filter: "blur(4px)" }} animate={{ opacity: 1, y: 0, filter: "blur(0px)" }} transition={{ delay: 0.2, duration: 0.3 }}>
                  <span className="text-[16px] sm:text-[20px] text-[#2A2A2A] font-outfit font-light flex-shrink-0">{currency}</span>
                  <span className="font-bold font-outfit text-white tracking-[-0.03em] leading-none truncate min-w-0 flex-1" style={{ fontSize: "clamp(20px, 7.2vw, 38px)" }}>
