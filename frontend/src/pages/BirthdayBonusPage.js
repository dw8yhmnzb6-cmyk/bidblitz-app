...
export default function BirthdayBonusPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D14] py-8 px-4" data-testid="birthday-bonus-page">
        ...
        {loading ? (
          ...
          <Card className="bg-gradient-to-r from-[#EC4899]/30 to-[#F59E0B]/30 border-[#EC4899] mb-6">
            <CardContent className="p-8 text-center">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">{t.happyBirthday}</h2>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#94A3B8] text-sm">{t.yourBirthday}</p>
                ...
                {status.already_claimed ? (
                  ...
                  <div className="text-right">
                    <p className="text-[#94A3B8] text-sm">{t.comingSoon}</p>
          ...
          <Card className="bg-[#1A1A2E] border-white/10 mb-6">
            <CardContent className="p-6">
              <h3 className="text-white font-bold mb-4">{t.setBirthday}</h3>
          ...
          <CardContent>
            <div className="space-y-2">
              {bonusLevels.map((level) => (
                <div key={level.level} className="flex items-center justify-between bg-[#0D0D14] rounded-lg p-3">
            ...
            <p className="text-[#94A3B8] text-sm mt-4 text-center">{t.vipBonus}</p>
          </CardContent>
        </Card>
      </div>
    </div>
