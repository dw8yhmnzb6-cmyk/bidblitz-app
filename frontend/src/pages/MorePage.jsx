...
export const MorePage = ({ onNavigate, kidsReturn, onKidsHandled, isGuest, isDemoMode, onAuthRequired, onLogin, onRegister, onStartDemo }) => {
  ...
  const growthMenu = [
    ...
    { id: "merchant-onboarding", icon: TrendingUp, label: t("onboarding.title") || "Become a Merchant", desc: t("onboarding.menu_desc") || "Free trial & onboarding", color: "#00C2FF", action: () => onNavigate("/merchant-onboarding") },
