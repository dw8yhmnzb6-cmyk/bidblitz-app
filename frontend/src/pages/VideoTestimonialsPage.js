...
export default function VideoTestimonialsPage() {
  ...
  const texts = {
    de: {
      ...
      description: 'Schau dir an, was andere bei bidblitz.ae gewonnen haben!',
      featured: 'Empfohlen',
      uploadTitle: 'Teile dein Gewinner-Video!',
      uploadDesc: 'Hast du bei bidblitz.ae gewonnen? Lade ein Video hoch und erhalte 15 Gratis-Gebote!',
    ...
    en: {
      ...
      description: 'See what others have won at bidblitz.ae!',
      featured: 'Featured',
      uploadTitle: 'Share your winner video!',
      uploadDesc: 'Won at bidblitz.ae? Upload a video and get 15 free bids!',
