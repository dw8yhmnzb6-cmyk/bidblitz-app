...
const LevelsPage = () => {
  ...
  const texts = {
    de: {
      ...
      leaderboard: 'XP Rangliste',
      howToEarn: 'So verdienst du XP',
      perBid: 'XP pro Gebot',
      perWin: 'XP pro Gewinn',
      perPurchase: 'XP pro €10 Kauf',
      perLogin: 'XP pro Tag Login',
      perReview: 'XP pro Bewertung',
      perReferral: 'XP pro Empfehlung',
      unlockAt: 'Freischalten bei',
      xp: 'XP',
      rank: 'Platz',
      recentXp: 'Letzte XP-Aktivität'
    },
    en: {
      title: 'Level System',
      subtitle: 'Level up and unlock exclusive perks!',
      ...
      perBid: 'XP per bid',
      perWin: 'XP per win',
      perPurchase: 'XP per €10 purchase',
      perLogin: 'XP per daily login',
      perReview: 'XP per review',
      perReferral: 'XP per referral',
      unlockAt: 'Unlock at',
      xp: 'XP',
      rank: 'Rank',
  ...
  return (
    <div className="min-h-screen bg-[#050509] py-8 px-4" data-testid="levels-page">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
