...
const translations = {
  de: {
    title: 'Händler-Gutscheine', subtitle: 'Ersteigere Gutscheine bei lokalen Partnern',
    allMerchants: 'Alle Händler', searchPlaceholder: 'Händler suchen...',
    filterAll: 'Alle', filterRestaurant: 'Restaurants', filterBar: 'Bars', filterCafe: 'Cafés',
    filterRetail: 'Einzelhandel', filterWellness: 'Wellness', filterOther: 'Sonstige',
    noMerchants: 'Keine Händler gefunden', vouchers: 'Gutscheine', noVouchers: 'Noch keine Gutscheine verfügbar',
    value: 'Wert', currentPrice: 'Aktueller Preis', bids: 'Gebote', endsIn: 'Endet in',
    bidNow: 'Jetzt bieten', viewMerchant: 'Händler ansehen', back: 'Zurück',
    activeAuctions: 'Aktive Auktionen', wonVouchers: 'Gewonnene Gutscheine', redeemAt: 'Einlösbar bei',
    savings: 'Ersparnis', hot: 'Beliebt', new: 'Neu', endingSoon: 'Endet bald',
    premium: 'Premium Partner', verified: 'Verifiziert', openingHours: 'Öffnungszeiten',
    gallery: 'Galerie', contact: 'Kontakt', website: 'Website', specialties: 'Spezialitäten',
    paymentMethods: 'Zahlungsarten', reviews: 'Bewertungen',
    monday: 'Montag', tuesday: 'Dienstag', wednesday: 'Mittwoch', thursday: 'Donnerstag',
    friday: 'Freitag', saturday: 'Samstag', sunday: 'Sonntag', closed: 'Geschlossen',
    winnerGets: 'Gewinner erhält', redeemInfo: 'Nach dem Gewinn können Sie diesen Gutschein direkt beim Händler einlösen.',
    howItWorks: 'So funktioniert\'s', step1: 'Wählen Sie einen Händler', step2: 'Bieten Sie auf einen Gutschein',
    step3: 'Gewinnen Sie und lösen Sie beim Händler ein', availableVouchers: 'Verfügbare Gutscheine', comingSoon: 'Bald verfügbar'
  },
  en: {
