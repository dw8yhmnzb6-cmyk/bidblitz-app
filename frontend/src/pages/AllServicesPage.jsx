...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Plane, label: "Flüge", desc: "Flugsuche, 3% Cashback", route: "/flights", color: "#06B6D4" },
      { icon: Plane, label: "Flüge LIVE (Sabre)", desc: "Weltweite Echtzeit-Flüge", route: "/flights-live", color: "#00D26A", badge: "LIVE" },
