...
// Partner Map Component (with Google Maps placeholder)
function PartnerMap({ partners, userLocation }) {
  // For now, show a list with Google Maps links
  // Full Google Maps integration would require API key
      ...
      <div className="aspect-video bg-gray-100 relative">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">Interaktive Karte</p>
            {userLocation && (
              <a
                href={`https://www.google.com/maps/search/partner+near+me/@${userLocation.latitude},${userLocation.longitude},14z`}
                target="_blank"
          ...
          >
            <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
              {partner.logo_url ? (
                ...
                <span className="text-xl">{BUSINESS_ICONS[partner.business_type] || '🏪'}</span>
              )}
            </div>
            <div className="flex-1 min-w-0">
            ...
            {partner.distance_km && (
              <span className="text-sm text-gray-400">{partner.distance_km} km</span>
            )}
            {(partner.latitude && partner.longitude) && (
              <a
                ...
                className="p-2 text-amber-500 hover:bg-amber-50 rounded-full"
              >
