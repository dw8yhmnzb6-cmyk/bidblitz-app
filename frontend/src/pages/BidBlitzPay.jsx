...
import { 
  ...
  Plus, Minus, X, Shield, Loader2, Camera, ScanLine, Banknote, Percent
} from 'lucide-react';
...
const translations = {
  de: {
    wallet: 'Geldbörse', pay: 'Bezahlen', send: 'Senden', history: 'Verlauf',
    vouchers: 'Gutscheine', security: 'Sicherheit', sendMoney: 'Geld senden',
    availableBalance: 'Verfügbares Guthaben', partnerVouchers: 'Partner-Gutscheine',
    universal: 'Universell', showQR: 'Zeige diesen QR-Code',
    partnerScans: 'Partner scannt, um Zahlung zu akzeptieren',
    howItWorks: 'So funktioniert\'s', transactionHistory: 'Transaktionsverlauf',
    noTransactions: 'Noch keine Transaktionen', noVouchers: 'Noch keine Gutscheine',
    winVouchers: 'Gewinne Gutscheine bei Auktionen!', toAuctions: 'Zu Auktionen',
    login: 'Anmelden', pleaseLogin: 'Bitte anmelden, um fortzufahren',
    ...
    interestRate: 'Zinssatz', monthlyPayment: 'Monatliche Rate',
    totalRepayment: 'Gesamtrückzahlung', creditPurpose: 'Verwendungszweck',
    idFront: 'Ausweis Vorderseite', idBack: 'Ausweis Rückseite',
    selfieWithId: 'Selfie mit Ausweis', incomeProof: 'Einkommensnachweis',
    month1: 'Monat 1', month2: 'Monat 2', month3: 'Monat 3',
    uploadDocuments: 'Dokumente hochladen', submitApplication: 'Antrag einreichen',
    creditStatus: 'Kreditstatus', pending: 'In Prüfung', approved: 'Genehmigt',
    rejected: 'Abgelehnt', active: 'Aktiv', repaid: 'Zurückgezahlt',
    remainingAmount: 'Restbetrag', makePayment: 'Zahlung leisten',
    myCredits: 'Meine Kredite', noCredits: 'Noch keine Kredite',
    creditEligibility: 'Kreditberechtigung', eligible: 'Berechtigt',
    notEligible: 'Nicht berechtigt', verificationRequired: 'Verifizierung erforderlich',
    openCreditExists: 'Offener Kredit vorhanden', repayFirst: 'Bitte zuerst zurückzahlen',
    applicationSubmitted: 'Antrag eingereicht', awaitingReview: 'Wartet auf Prüfung',
    noInterestUnder50: 'Keine Zinsen unter €50', flexibleRepayment: 'Flexible Rückzahlung',
    creditTerms: 'Kreditbedingungen', iAccept: 'Ich akzeptiere die'
  },
  en: {
    send: 'Senden',
    history: 'Verlauf',
  ...
  el: {
    ...
    sent: 'Απεσταλμένα',
    received: 'Ληφθέντα',
    noTransfers: 'Δεν υπάρχουν μεταφορές ακόμα',
    ...
    shareQRToGetPaid: 'Μοιραστείτε αυτόν τον QR κώδικα για να πληρωθείτε',
    ...
    minCashback: 'Απαιτείται ελάχιστο €5',
    directTopUp: 'Άμεση Αναπλήρωση',
    directTopUpDesc: 'Προσθέστε υπόλοιπο με κάρτα',
    ...
    universal: 'Καθολικό',
    showQR: 'Δείξτε αυτόν τον QR Κώδικα',
    partnerScans: 'Ο συνεργάτης σαρώνει για αποδοχή πληρωμής',
    availableForPayment: 'Διαθέσιμο για πληρωμή',
    qrValidFor: 'QR κώδικας ισχύει για 5 λεπτά',
    generateNew: 'Δημιουργία νέου κώδικα',
    howItWorks: 'Πώς λειτουργεί',
    step1: 'Δείξτε στον συνεργάτη αυτόν τον QR κώδικα',
    ...
    noVouchers: 'Δεν υπάρχουν κουπόνια ακόμα',
...
const BidBlitzPay = () => {
  ...
  useEffect(() => {
    ...
    fetchMainBalance();
    fetchCustomerNumber();
  }, [fetchWallet, fetchTransactions, fetchMainBalance, fetchCustomerNumber]);
