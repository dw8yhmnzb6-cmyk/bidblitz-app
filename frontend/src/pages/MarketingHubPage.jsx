...
const FEATURES = [
  ...
  },
  {
    ...
    hint: "Link + Titel + kurzer Werbetext.",
    inputs: [
      { name: "title", label: "Titel", placeholder: "z.B. 50% auf Pizza" },
      { name: "description", label: "Kurztext", placeholder: "Nur heute bei Pizza Max!" },
      { name: "link_route", label: "Link (interner Pfad)", placeholder: "/marketplace oder /taxi" },
      { name: "color", label: "Akzentfarbe (optional)", placeholder: "#00C2FF" },
    ],
    ...
    buildBody: (tier, inp) => ({
      ...
      link_route: inp.link_route || "",
      color: inp.color || "#00C2FF",
    }),
  },
  {
    id: "kyc_express",
