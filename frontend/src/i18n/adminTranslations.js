...
export const adminTranslations = {
  ...
  tr: {
    ...
    todayBids: 'Bugünkü Teklifler',
    weeklyRevenue: 'Haftalık Gelir',
    recentBids: 'Son Teklifler',
    topBidders: 'En Çok Teklif Verenler',
    ...
    auctionCreated: 'Açık artırma oluşturuldu',
    auctionExtended: 'Açık artırma uzatıldı',
    auctionEnded: 'Açık artırma sona erdi',
    auctionDeleted: 'Açık artırma silindi',
    userBlocked: 'Kullanıcı engellendi',
    userUnblocked: 'Kullanıcı engeli kaldırıldı',
    bidsAdded: 'Teklifler eklendi',
  ...
  fr: {
    ...
    todayBids: 'Enchères Aujourd\'hui',
    weeklyRevenue: 'Revenu Hebdomadaire',
    recentBids: 'Enchères Récentes',
    topBidders: 'Meilleurs Enchérisseurs',
    ...
    auctionCreated: 'Enchère créée',
    auctionExtended: 'Enchère prolongée',
    auctionEnded: 'Enchère terminée',
    auctionDeleted: 'Enchère supprimée',
    userBlocked: 'Utilisateur bloqué',
    userUnblocked: 'Utilisateur débloqué',
    bidsAdded: 'Enchères ajoutées',
  ...
  es: {
    ...
    todayBids: 'Pujas de Hoy',
    weeklyRevenue: 'Ingresos Semanales',
    recentBids: 'Pujas Recientes',
    topBidders: 'Mejores Pujadores',
  ...
  sq: {
    ...
    todayBids: 'Ofertat e Sotme',
    weeklyRevenue: 'Të Ardhurat Javore',
    recentBids: 'Ofertat e Fundit',
    topBidders: 'Ofertuesit Kryesorë',
    addProduct: 'Shto Produkt',
    productName: 'Emri i Produktit',
    description: 'Përshkrimi',
    category: 'Kategoria',
    retailPrice: 'Çmimi i Shitjes',
    ...
    confirm: 'Konfirmo',
    actions: 'Veprimet',
    productCreated: 'Produkti u krijua',
    productUpdated: 'Produkti u përditësua',
    productDeleted: 'Produkti u fshi',
    auctionCreated: 'Ankandi u krijua',
    auctionExtended: 'Ankandi u zgjat',
    auctionEnded: 'Ankandi përfundoi',
    auctionDeleted: 'Ankandi u fshi',
    userBlocked: 'Përdoruesi u bllokua',
    userUnblocked: 'Përdoruesi u zhbllokua',
    bidsAdded: 'Ofertat u shtuan',
