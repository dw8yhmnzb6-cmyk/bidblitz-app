...
export const walletTranslations = {
  de: {
    ...
    clickAddContact: 'Klicken Sie auf "Neu" um einen Kontakt hinzuzufügen',
    savedContacts: 'Gespeicherte Kontakte',
    saveFrequentRecipients: 'Speichern Sie häufige Empfänger',
    newContact: 'Neu',
    addNewContact: 'Neuen Kontakt hinzufügen',
    editContact: 'Kontakt bearbeiten',
    contactSaved: 'Kontakt gespeichert!',
    contactUpdated: 'Kontakt aktualisiert!',
    customerNumberOrEmail: 'Kundennummer oder E-Mail',
    customerNumberExample: 'z.B. BID-123456 oder email@example.com',
    nickname: 'Spitzname',
    newNickname: 'Neuer Spitzname',
    nicknameExample: 'z.B. Mama, Max, Arbeit',
    edit: 'Bearbeiten',
    delete: 'Löschen',
    ...
    scanningQR: 'Scanne QR-Code...',
    qrDetected: 'QR-Code erkannt!',
    invalidQR: 'Ungültiger QR-Code',
    qrReadError: 'QR-Code konnte nicht gelesen werden. Bitte versuchen Sie es erneut.',
    saveQRCode: 'QR-Code speichern',
    shareQRCode: 'Teilen',
    qrDownloaded: 'QR-Code heruntergeladen!',
    sharedSuccessfully: 'Erfolgreich geteilt!',
    takePhotoNow: '📷 Jetzt QR-Code fotografieren',
    alternativeLiveCamera: 'Alternative: Live-Kamera (funktioniert nicht immer)',
    ...
    pinCode: 'PIN-Code',
    transactionLimit: 'Transaktionslimit',
  ...
  en: {
    ...
    transferToMain: 'Transfer to main account',
    available: 'Available',
    paymentCouldNotCreate: 'Could not create payment',
    ...
    clickAddContact: 'Click "Add" to add a contact',
    savedContacts: 'Saved Contacts',
    saveFrequentRecipients: 'Save frequent recipients',
    newContact: 'Add',
    addNewContact: 'Add New Contact',
    editContact: 'Edit Contact',
    contactSaved: 'Contact saved!',
    contactUpdated: 'Contact updated!',
    customerNumberOrEmail: 'Customer ID or Email',
    customerNumberExample: 'e.g. BID-123456 or email@example.com',
    nickname: 'Nickname',
    newNickname: 'New Nickname',
    nicknameExample: 'e.g. Mom, Max, Work',
    edit: 'Edit',
    delete: 'Delete',
    ...
    qrReadError: 'Could not read QR code. Please try again.',
    saveQRCode: 'Save QR Code',
    shareQRCode: 'Share',
    qrDownloaded: 'QR code downloaded!',
    sharedSuccessfully: 'Shared successfully!',
    takePhotoNow: '📷 Photograph QR Code Now',
    alternativeLiveCamera: 'Alternative: Live camera (may not always work)',
    ...
    // Camera & QR Errors
    cameraAccessDenied: 'Camera access denied. Please allow camera in browser settings and reload the page.',
    cameraStartError: 'Camera could not be started. Please use "Take Photo".',
    qrScanInstruction: 'Scan QR code with camera or use "Take Photo"',
    scanQROrUpload: 'Scan QR code or upload image',
    chooseScanOption: 'Choose one of the options below to scan',
    worksReliably: '✅ Works reliably on iPhone, iPad & Android!'
  },
  ...
  sq: {
    ...
    invalidAmount: 'Shuma e pavlefshme',
    ...
    enterName: 'Ju lutem vendosni emrin',
    recipientSaved: 'Marrësi u ruajt!',
    recipientDeleted: 'Marrësi u fshi',
    selected: 'zgjedhur',
    savedRecipients: 'Marrësit e ruajtur',
    transferSuccessful: 'Transferta u krye me sukses!',
    saveFutureTransfers: 'Ruaj për transferta të ardhshme?',
    recipient: 'Marrësi',
    ...
    // Contact Management
    noContactsSaved: 'Ende nuk ka kontakte të ruajtura',
    clickAddContact: 'Klikoni "Shto" për të shtuar një kontakt',
    savedContacts: 'Kontaktet e ruajtura',
    saveFrequentRecipients: 'Ruaj marrësit e shpeshtë',
    newContact: 'Shto',
    addNewContact: 'Shto kontakt të ri',
    editContact: 'Ndrysho kontaktin',
    contactSaved: 'Kontakti u ruajt!',
    contactUpdated: 'Kontakti u përditësua!',
    customerNumberOrEmail: 'Numri i klientit ose Email',
    customerNumberExample: 'p.sh. BID-123456 ose email@example.com',
    nickname: 'Emri i shkurtër',
    newNickname: 'Emri i ri i shkurtër',
    nicknameExample: 'p.sh. Mama, Baba, Punë',
    edit: 'Ndrysho',
    delete: 'Fshi',
    
    // QR Scanner
    manualEntry: 'Hyrje manuale',
    cameraReady: 'Kamera gati ✓',
    cameraPermissionRequired: 'Kërkohet leja e kamerës',
    scanningQR: 'Duke skanuar QR-kodin...',
    qrDetected: 'QR-kodi u zbulua!',
    invalidQR: 'QR-kod i pavlefshëm',
    qrReadError: 'QR-kodi nuk mund të lexohet. Ju lutem provoni përsëri.',
    saveQRCode: 'Ruaj QR-kodin',
    shareQRCode: 'Ndaj',
    qrDownloaded: 'QR-kodi u shkarkua!',
    sharedSuccessfully: 'U nda me sukses!',
    takePhotoNow: '📷 Fotografo QR-kodin tani',
    alternativeLiveCamera: 'Alternativë: Kamera live (nuk funksionon gjithmonë)',
    takePhoto: 'Bëj foto',
    paymentRequest: 'Kërkesë pagese',
    copiedToClipboard: 'U kopjua në clipboard!',
    errorUpdating: 'Gabim në përditësim',
    recommended: 'Rekomanduar',
    
    // Security
    biometricAuth: 'Autentifikimi biometrik',
    pinCode: 'Kodi PIN',
    transactionLimit: 'Limiti i transaksionit',
    enableBiometric: 'Aktivizo biometrinë',
    disableBiometric: 'Çaktivizo biometrinë',
    biometricEnabled: 'Biometria u aktivizua',
    biometricDisabled: 'Biometria u çaktivizua',
    setPin: 'Vendos PIN',
    changePin: 'Ndrysho PIN',
    enterCurrentPin: 'Vendos PIN-in aktual',
    enterNewPin: 'Vendos PIN-in e ri',
    confirmNewPin: 'Konfirmo PIN-in e ri',
    pinSet: 'PIN u vendos',
