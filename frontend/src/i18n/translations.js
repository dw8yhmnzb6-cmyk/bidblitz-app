...
export const translations = {
  ...
  en: {
    ...
    auctionPage: {
      ...
      activityCalm: "Calm",
      discoverFeatures: "Discover all Features & Extras",
      howItWorks: "HOW IT WORKS",
      step1: "Buy",
      step2: "Bid",
      step3: "Win",
  ...
  ar: {
    ...
    auctionPage: {
      ...
      categories: { all: "الكل", electronics: "إلكترونيات", smartphones: "هواتف ذكية", household: "منزلية", emobility: "تنقل كهربائي", gifts: "هدايا", fashion: "أزياء" },
      active: "نشط", scheduled: "مجدول", all: "الكل",
      offersFound: "العروض الموجودة",
      noOffers: "لم يتم العثور على عروض",
      tryAnother: "جرب فئة أو بحث آخر",
      priceNote: "سعر المقارنة = سعر التجزئة المقترح",
      ...
      beginnerAuctions: "مزادات المبتدئين",
      freeAuctions: "مزادات القسائم",
      voucherAuctions: "قسائم العروض",
      freeAuctionInfo: "زايد بالعروض المشتراة - القسيمة مجانية عند الفوز!",
      nightAuctions: "المزادات الليلية",
      vipAuctions: "مزادات VIP",
      endedAuctions: "المزادات المنتهية",
      recentWinners: "انتهت مؤخراً",
      showAll: "عرض الكل",
      showAllLive: "عرض جميع المزادات المباشرة",
      noAuctionsInCategory: "لا توجد مزادات في هذه الفئة",
      topOffer: "أفضل عرض لدينا اليوم!",
      currentPrice: "السعر الحالي",
      remaining: "المتبقي",
      bidNow: "زايد الآن",
      bidsCount: "العروض",
      lastSoldFor: "بيع آخر مرة بـ",
      activity: "النشاط",
      uvp: "السعر الأصلي",
      ...
      bid: "زايد",
      nightOnly: "ليلي فقط",
      freeBidPayEnd: "زايد مجاناً • ادفع السعر النهائي",
      nightTime: "فقط 23:30-06:00",
      secure: "آمن",
      auctionTypes: "أنواع المزادات",
      discount: "خصم",
      beginner: "مبتدئ",
      free: "مجاني",
      ...
      activityHigh: "مرتفع",
      activityVeryHigh: "مرتفع جداً",
      activityHot: "ساخن",
      activityActive: "نشط",
      activityCalm: "هادئ",
      discoverFeatures: "اكتشف جميع المميزات والإضافات",
      howItWorks: "كيف يعمل",
  ...
  sq: {
    ...
    auctionPage: {
      ...
      activityCalm: "E qetë",
      discoverFeatures: "Zbulo të gjitha Veçoritë & Ekstrat",
      howItWorks: "Si funksionon",
      step1: "Bli",
      step2: "Oferoni",
      step3: "Fitoni",
