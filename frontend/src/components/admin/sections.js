...
export const ADMIN_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "wholesale", icon: Package, label: "Großhändler", nav: "/admin/merchants" },
      { key: "sepa", icon: Euro, label: "SEPA-Auszahlungen", nav: "/admin/payouts" },
    ],
  },
  {
    title: "Marketing", color: "#F59E0B", count: 8,
    items: [
      { key: "flash-sales", icon: Zap, label: "Flash Sales", nav: "/admin/ads" },
      ...
      { key: "jackpot", icon: Trophy, label: "Jackpot", nav: "/admin/auctions" },
      { key: "challenges", icon: Target, label: "Challenges", nav: "/admin/ads" },
      { key: "mystery-box", icon: Gift, label: "Mystery Box", nav: "/admin/ads" },
