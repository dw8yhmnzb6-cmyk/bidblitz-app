    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mt-2">Lade Bewerbungen...</p>
        </div>
      ) : applications.length === 0 ? (
        <div className="text-center py-12 bg-gray-800/30 rounded-xl border border-gray-700">
          <Building2 className="w-12 h-12 text-gray-600 mx-auto mb-3" />
          <p className="text-gray-400">Keine Bewerbungen gefunden</p>
        </div>
      ) : (
        <div className="space-y-4">
          {applications.map((app) => (
            ...
            >
              {/* Application Header */}
              <div 
                className="p-4 flex items-center justify-between cursor-pointer hover:bg-gray-800/70 transition-colors"
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">{app.restaurant_name}</h3>
                    <p className="text-gray-400 text-sm">{app.city} • {app.contact_name}</p>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-700 p-4 space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-gray-400 text-xs">Ansprechpartner</p>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${app.email}`} className="text-orange-400 text-sm hover:underline">
                          {app.email}
                        </a>
                      </div>
                    </div>
