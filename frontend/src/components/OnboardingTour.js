...
const translations = {
  ...
  ar: {
    welcome: 'مرحباً بك في BidBlitz!',
    welcomeDesc: 'تعلم كيف توفر حتى 99% في 30 ثانية فقط.',
    step1Title: '1. كيف يعمل؟',
    step1Desc: 'كل مزاد يبدأ من €0.00. كل مزايدة ترفع السعر بسنت واحد فقط وتمدد المؤقت 10-20 ثانية.',
    step1Tip: '💡 نصيحة: راقب المؤقت - كلما انخفض، زادت الإثارة!',
    step2Title: '2. كيف تفوز',
    step2Desc: 'آخر شخص يزايد عند انتهاء المؤقت يفوز بالمنتج بالسعر الحالي - غالباً يورو قليلة فقط!',
    step2Tip: '💡 نصيحة: راقب أولاً قبل المزايدة!',
    step3Title: '3. استراتيجيتك',
    step3Desc: 'استخدم Bid Buddy - يزايد تلقائياً عنك. لا تفوت أي مزاد!',
    step3Tip: '💡 نصيحة: حدد ميزانية مع Bid Buddy!',
    step4Title: '🎉 أنت جاهز!',
    step4Desc: 'تحصل على 10 مزايدات مجانية للتجربة. اضغط "زايد الآن" على أي مزاد!',
    skip: 'تخطي',
    next: 'التالي',
    back: 'رجوع',
    startBidding: 'إلى المزادات!',
    freeBids: '10 مزايدات مجانية',
    gotIt: 'فهمت!',
    clickToTry: 'اضغط للتجربة',
    completed: 'اكتملت الجولة!',
    reward: 'حصلت على 10 مزايدات مجانية!',
    dontShowAgain: 'لا تظهر مرة أخرى'
  },
  es: {
    welcome: '¡Bienvenido a BidBlitz!',
    welcomeDesc: 'Aprende cómo ahorrar hasta un 99% en solo 30 segundos.',
    step1Title: '1. ¿Cómo funciona?',
    step1Desc: 'Cada subasta comienza en €0.00. Cada puja sube el precio solo 1 céntimo y extiende el temporizador 10-20 segundos.',
    step1Tip: '💡 Consejo: Mira el temporizador - ¡cuanto más bajo, más emocionante!',
    step2Title: '2. Cómo ganar',
    step2Desc: 'La última persona en pujar cuando el temporizador termina gana el producto al precio actual - ¡a menudo solo unos pocos euros!',
    step2Tip: '💡 Consejo: ¡Observa primero antes de pujar!',
    step3Title: '3. Tu estrategia',
    step3Desc: 'Usa el Bid Buddy - puja automáticamente por ti. ¡Nunca te pierdas una subasta!',
    step3Tip: '💡 Consejo: ¡Establece un límite de presupuesto con Bid Buddy!',
    step4Title: '🎉 ¡Estás listo!',
    step4Desc: 'Recibes 10 pujas gratis para probar. ¡Haz clic en "Pujar" en cualquier subasta!',
    skip: 'Saltar',
    next: 'Siguiente',
    back: 'Atrás',
    startBidding: '¡Ir a Subastas!',
    freeBids: '10 Pujas Gratis',
    gotIt: '¡Entendido!',
    clickToTry: 'Haz clic para probar',
    completed: '¡Tour completado!',
    reward: '¡Has recibido 10 pujas gratis!',
...
const OnboardingTour = () => {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      ...
      // Set session skip to prevent re-showing in same session
      sessionStorage.setItem('bidblitz_onboarding_session_skip', 'true');
