...
export const translations = {
  de: {
    ...
    referral: 'Partner werben',
    yourReferralCode: 'Dein Empfehlungscode',
    referralBonus: 'Erhalte €10 für jeden geworbenen Partner!',
    totalReferrals: 'Empfehlungen',
    successful: 'Erfolgreich',
    pendingBonus: 'Ausstehender Bonus',
    ...
    startTime: 'Startzeit',
    endTime: 'Endzeit',
    notifyCustomers: 'Kunden benachrichtigen',
    saleCreated: 'Aktion erstellt!',
    saleCancelled: 'Aktion abgebrochen',
    active: 'Aktiv',
    scheduled: 'Geplant',
    ended: 'Beendet',
    noSales: 'Noch keine Aktionen erstellt',
    socialSharing: 'Social Media',
    shareNow: 'Jetzt teilen',
    shareStats: 'Sharing-Statistiken',
    shares: 'Geteilt',
    clicks: 'Klicks',
    conversions: 'Aktionen',
    topPlatform: 'Beste Plattform',
    postIdeas: 'Post-Ideen',
    ...
    anotherPayment: 'Weitere Zahlung',
    enterAmount: '1. Zahlungsbetrag eingeben',
    proceedToScan: 'Weiter zum Scannen',
    scanCustomerCode: '2. Kunden-Code scannen',
    orEnterManually: 'oder manuell eingeben',
    customerCode: 'Kunden-Code',
    confirmPayment: '3. Zahlung bestätigen',
    customer: 'Kunde',
    customerBalance: 'Kundenguthaben',
    chargeCustomer: 'Kunden belasten',
    howItWorks: 'So funktioniert BidBlitz Pay:',
    step1Pay: '1. Kunde lädt Guthaben in der BidBlitz App auf',
    step2Pay: '2. Kunde zeigt QR-Code an Ihrer Kasse',
    step3Pay: '3. Sie scannen den Code und geben den Betrag ein',
  ...
  en: {
    ...
    // Marketing translations
    referral: 'Refer Partners',
    yourReferralCode: 'Your Referral Code',
    referralBonus: 'Earn €10 for every referred partner!',
    ...
    scheduled: 'Scheduled',
    ended: 'Ended',
    noSales: 'No sales created yet',
    socialSharing: 'Social Media',
    shareNow: 'Share Now',
    shareStats: 'Sharing Statistics',
    shares: 'Shares',
    clicks: 'Clicks',
    ...
    anotherPayment: 'Another payment',
    enterAmount: '1. Enter payment amount',
    proceedToScan: 'Proceed to scan',
    scanCustomerCode: '2. Scan customer code',
    orEnterManually: 'or enter manually',
    customerCode: 'Customer code',
    confirmPayment: '3. Confirm payment',
    customer: 'Customer',
    customerBalance: 'Customer balance',
    chargeCustomer: 'Charge customer',
    howItWorks: 'How BidBlitz Pay works:',
    step1Pay: '1. Customer loads credit in BidBlitz app',
    step2Pay: '2. Customer shows QR code at your checkout',
    step3Pay: '3. You scan the code and enter the amount',
