...
const translations = {
  de: {
    ...
    shareOn: "Teilen auf",
    shareText: "Ich habe gerade bei bidblitz.ae gewonnen! 🎉",
  ...
  en: {
    ...
    shareOn: "Share on",
    shareText: "I just won at bidblitz.ae! 🎉",
  ...
  sq: {
    ...
    shareText: "Sapo fitova në bidblitz.ae! 🎉",
  ...
  tr: {
    ...
    shareOn: "Paylaş",
    shareText: "bidblitz.ae'de kazandım! 🎉",
  ...
  fr: {
    ...
    shareText: "Je viens de gagner sur bidblitz.ae! 🎉",
