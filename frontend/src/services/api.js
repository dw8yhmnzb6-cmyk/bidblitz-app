...
export const api = {
  ...
  // Investor portal auth & portal
  investorPortalRegister: (body) => request("/api/investor-portal/auth/register", { method: "POST", body: JSON.stringify(body) }),
  investorPortalLogin: (body) => request("/api/investor-portal/auth/login", { method: "POST", body: JSON.stringify(body) }),
  investorPortalLogout: () => request("/api/investor-portal/auth/logout", { method: "POST" }),
  investorPortalMe: () => request("/api/investor-portal/auth/me"),
  investorPortalRefresh: () => request("/api/investor-portal/auth/refresh", { method: "POST" }),
  getInvestorPortalDashboard: () => request("/api/investor-portal/portal/dashboard"),
  getInvestorPortalDocuments: () => request("/api/investor-portal/portal/documents"),
  acknowledgeInvestorDocument: (documentId) => request(`/api/investor-portal/portal/documents/${documentId}/acknowledge`, { method: "POST" }),
  getInvestorPortalUpdates: () => request("/api/investor-portal/portal/updates"),
  getInvestorPortalQuestions: () => request("/api/investor-portal/portal/questions"),
  createInvestorPortalQuestion: (body) => request("/api/investor-portal/portal/questions", { method: "POST", body: JSON.stringify(body) }),
  replyInvestorPortalQuestion: (questionId, body) => request(`/api/investor-portal/portal/questions/${questionId}/reply`, { method: "POST", body: JSON.stringify(body) }),
  getInvestorPortalMeetings: () => request("/api/investor-portal/portal/meetings"),
  createInvestorPortalMeetingRequest: (body) => request("/api/investor-portal/portal/meetings/request", { method: "POST", body: JSON.stringify(body) }),
  getInvestorPortalProfile: () => request("/api/investor-portal/portal/profile"),
  updateInvestorPortalProfile: (body) => request("/api/investor-portal/portal/profile", { method: "PATCH", body: JSON.stringify(body) }),
  getAdminInvestorLeads: () => request("/api/investor-portal/admin/leads"),
  exportAdminInvestorLeads: () => downloadCSV("/api/investor-portal/admin/leads/export", "investor-leads.csv"),
  updateAdminInvestorLeadStatus: (accountId, body) => request(`/api/investor-portal/admin/leads/${accountId}/status`, { method: "PATCH", body: JSON.stringify(body) }),
  messageAdminInvestorLead: (accountId, body) => request(`/api/investor-portal/admin/leads/${accountId}/message`, { method: "POST", body: JSON.stringify(body) }),
  getAdminInvestorDocuments: () => request("/api/investor-portal/admin/documents"),
  createAdminInvestorDocument: (body) => request("/api/investor-portal/admin/documents", { method: "POST", body: JSON.stringify(body) }),
  updateAdminInvestorDocument: (documentId, body) => request(`/api/investor-portal/admin/documents/${documentId}`, { method: "PATCH", body: JSON.stringify(body) }),
  getAdminInvestorUpdates: () => request("/api/investor-portal/admin/updates"),
  createAdminInvestorUpdate: (body) => request("/api/investor-portal/admin/updates", { method: "POST", body: JSON.stringify(body) }),
  updateAdminInvestorUpdate: (updateId, body) => request(`/api/investor-portal/admin/updates/${updateId}`, { method: "PATCH", body: JSON.stringify(body) }),
  getAdminInvestorMeetings: () => request("/api/investor-portal/admin/meetings"),
  ...
  getMerchantOpsSuite: () => request("/api/merchant-portal/v5/ops-suite"),
  getMerchantDealerInventory: () => request("/api/merchant-portal/dealer/inventory"),
  getMerchantDealerReorders: () => request("/api/merchant-portal/dealer/reorders"),
  createMerchantDealerReorder: (body) => request("/api/merchant-portal/dealer/reorders/create", { method: "POST", body: JSON.stringify(body) }),
  getMerchantDealerInvoices: () => request("/api/merchant-portal/dealer/invoices"),
  getMerchantDealerMarketing: () => request("/api/merchant-portal/dealer/marketing"),
  getMerchantDealerBrandProfile: () => request("/api/merchant-portal/dealer/branding/profile"),
  updateMerchantDealerBrandProfile: (body) => request("/api/merchant-portal/dealer/branding/profile", { method: "POST", body: JSON.stringify(body) }),
  createMerchantDealerMarketingRequest: (body) => request("/api/merchant-portal/dealer/marketing/requests", { method: "POST", body: JSON.stringify(body) }),
  getMerchantDealerWarranty: () => request("/api/merchant-portal/dealer/warranty"),
  getMerchantDealerWarrantyPass: (claimId) => request(`/api/merchant-portal/dealer/warranty/pass/${encodeURIComponent(claimId)}`),
  createMerchantDealerWarranty: (body) => request("/api/merchant-portal/dealer/warranty/create", { method: "POST", body: JSON.stringify(body) }),
  updateMerchantDealerWarrantyStatus: (claimId, body) => request(`/api/merchant-portal/dealer/warranty/${encodeURIComponent(claimId)}/status`, { method: "POST", body: JSON.stringify(body) }),
  updateMerchantDealerServiceRequestStatus: (requestId, body) => request(`/api/merchant-portal/dealer/service-requests/${encodeURIComponent(requestId)}/status`, { method: "POST", body: JSON.stringify(body) }),
  upsertMerchantOpsCompany: (body) => request("/api/merchant-portal/v5/companies/upsert", { method: "POST", body: JSON.stringify(body) }),
  upsertMerchantOpsDocument: (body) => request("/api/merchant-portal/v5/documents/upsert", { method: "POST", body: JSON.stringify(body) }),
  upsertMerchantOpsMaintenance: (body) => request("/api/merchant-portal/v5/maintenance/upsert", { method: "POST", body: JSON.stringify(body) }),
  ...
  registerPosMerchant: (body) => request("/api/pos/merchants/register", { method: "POST", body: JSON.stringify(body) }),
  getMyPosMerchant: () => request("/api/pos/merchants/me"),
  createPosStore: (body) => request("/api/pos/stores/create", { method: "POST", body: JSON.stringify(body) }),
  getPosStores: () => request("/api/pos/stores"),
  createPosRegister: (body) => request("/api/pos/registers/create", { method: "POST", body: JSON.stringify(body) }),
  getPosRegisters: (storeId = "") => request(`/api/pos/registers${storeId ? `?store_id=${encodeURIComponent(storeId)}` : ""}`),
  openPosShift: (body) => request("/api/pos/shift/open", { method: "POST", body: JSON.stringify(body) }),
  getCurrentPosShift: (registerId) => request(`/api/pos/shift/current?register_id=${encodeURIComponent(registerId)}`),
  invitePosStaff: (body) => request("/api/pos/staff/invite", { method: "POST", body: JSON.stringify(body) }),
  createPosProduct: (body) => request("/api/pos/products/create", { method: "POST", body: JSON.stringify(body) }),
  searchPosProducts: ({ storeId, q = "", barcode = "", limit = 50 }) => request(`/api/pos/products/search?store_id=${encodeURIComponent(storeId)}${q ? `&q=${encodeURIComponent(q)}` : ""}${barcode ? `&barcode=${encodeURIComponent(barcode)}` : ""}&limit=${encodeURIComponent(limit)}`),
  lookupPosProduct: ({ storeId, barcode }) => request(`/api/pos/products/lookup?store_id=${encodeURIComponent(storeId)}&barcode=${encodeURIComponent(barcode)}`),
  createPosCart: (body) => request("/api/pos/cart/create", { method: "POST", body: JSON.stringify(body) }),
  ...
  // Merchant setup
  getMerchantSetupPresets: () => request("/api/merchant-setup/presets"),
  getMerchantSetupState: () => request("/api/merchant-setup/state"),
  saveMerchantSetupState: (body) => request("/api/merchant-setup/state", { method: "PUT", body: JSON.stringify(body) }),
  applyMerchantSetupPreset: (body) => request("/api/merchant-setup/apply-preset", { method: "POST", body: JSON.stringify(body) }),
  testMerchantHardware: (body) => request("/api/merchant-setup/hardware-test", { method: "POST", body: JSON.stringify(body) }),
  createMerchantOnboardingTestSale: (body) => request("/api/merchant-setup/test-sale", { method: "POST", body: JSON.stringify(body) }),
  getAdminMerchantOnboardingOverview: () => request("/api/merchant-setup/admin/overview"),
  ...
  getChargeWarrantyServiceHistory: (registrationId) => request(`/api/charge-app/warranty/${encodeURIComponent(registrationId)}/service-history`),
  ...
  updateChargeCatalogProductAdmin: (productId, body) => request(`/api/charge-app/admin/catalog/${encodeURIComponent(productId)}`, { method: "PUT", body: JSON.stringify(body) }),
  resetChargeCatalogProductAdmin: (productId) => request(`/api/charge-app/admin/catalog/${encodeURIComponent(productId)}`, { method: "DELETE" }),
  ...
  getPublicFeatures: (params = "") => request(`/api/features/public${params ? `?${params}` : ""}`),
  getFeatureNavigation: (params = "") => request(`/api/features/navigation${params ? `?${params}` : ""}`),
  checkFeature: (key, params = "") => request(`/api/features/check/${encodeURIComponent(key)}${params ? `?${params}` : ""}`),
  getFeatureControlAdmin: () => request("/api/admin/features"),
  createFeatureControlItem: (body) => request("/api/admin/features", { method: "POST", body: JSON.stringify(body) }),
  updateFeatureControlItem: (key, body) => request(`/api/admin/features/${encodeURIComponent(key)}`, { method: "PUT", body: JSON.stringify(body) }),
  enableFeatureControlItem: (key) => request(`/api/admin/features/${encodeURIComponent(key)}/enable`, { method: "POST" }),
  disableFeatureControlItem: (key) => request(`/api/admin/features/${encodeURIComponent(key)}/disable`, { method: "POST" }),
  maintenanceFeatureControlItem: (key, body) => request(`/api/admin/features/${encodeURIComponent(key)}/maintenance`, { method: "POST", body: JSON.stringify(body || {}) }),
  scheduleFeatureControlItem: (key, body) => request(`/api/admin/features/${encodeURIComponent(key)}/schedule`, { method: "POST", body: JSON.stringify(body) }),
  bulkFeatureControlAction: (body) => request("/api/admin/features/bulk", { method: "POST", body: JSON.stringify(body) }),
  getFeatureControlAudit: (key = "") => request(`/api/admin/features/audit${key ? `?key=${encodeURIComponent(key)}` : ""}`),
  rollbackFeatureControlItem: (key, body) => request(`/api/admin/features/${encodeURIComponent(key)}/rollback`, { method: "POST", body: JSON.stringify(body) }),
  applyFeatureControlPreset: (body) => request("/api/admin/features/presets/apply", { method: "POST", body: JSON.stringify(body) }),
  ...
  getAdminBioPayVendorDiagnostics: () => request("/api/admin/biopay/vendor-diagnostics"),
