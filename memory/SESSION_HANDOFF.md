...
- **Port:** 8001 (internal)
- **URL:** https://ocpp-csms-platform.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://ocpp-csms-platform.preview.emergentagent.com/api/health

# Frontend test
curl https://ocpp-csms-platform.preview.emergentagent.com/
```
