...
- **Port:** 8001 (internal)
- **URL:** https://super-app-portal.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://super-app-portal.preview.emergentagent.com/api/health

# Frontend test
curl https://super-app-portal.preview.emergentagent.com/
```
