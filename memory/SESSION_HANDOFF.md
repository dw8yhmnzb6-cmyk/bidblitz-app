...
- **Port:** 8001 (internal)
- **URL:** https://swipe-match-chat-8.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://swipe-match-chat-8.preview.emergentagent.com/api/health

# Frontend test
curl https://swipe-match-chat-8.preview.emergentagent.com/
```
