...
- **Port:** 8001 (internal)
- **URL:** https://floorplan-wizard-8.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://floorplan-wizard-8.preview.emergentagent.com/api/health

# Frontend test
curl https://floorplan-wizard-8.preview.emergentagent.com/
```
