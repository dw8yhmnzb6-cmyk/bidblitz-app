...
- **Port:** 8001 (internal)
- **URL:** https://bidblitz-staff.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://bidblitz-staff.preview.emergentagent.com/api/health

# Frontend test
curl https://bidblitz-staff.preview.emergentagent.com/
```
