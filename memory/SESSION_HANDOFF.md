...
- **Port:** 8001 (internal)
- **URL:** https://super-app-staging-2.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://super-app-staging-2.preview.emergentagent.com/api/health

# Frontend test
curl https://super-app-staging-2.preview.emergentagent.com/
```
