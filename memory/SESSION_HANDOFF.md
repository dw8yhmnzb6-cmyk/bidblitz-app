...
- **Port:** 8001 (internal)
- **URL:** https://kyc-approval-hub.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://kyc-approval-hub.preview.emergentagent.com/api/health

# Frontend test
curl https://kyc-approval-hub.preview.emergentagent.com/
```
