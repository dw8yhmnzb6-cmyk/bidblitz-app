...
- **Port:** 8001 (internal)
- **URL:** https://qr-checkout-20.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://qr-checkout-20.preview.emergentagent.com/api/health

# Frontend test
curl https://qr-checkout-20.preview.emergentagent.com/
```
