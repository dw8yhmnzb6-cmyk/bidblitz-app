...
- **Port:** 8001 (internal)
- **URL:** https://taxi-uber-style.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://taxi-uber-style.preview.emergentagent.com/api/health

# Frontend test
curl https://taxi-uber-style.preview.emergentagent.com/
```
