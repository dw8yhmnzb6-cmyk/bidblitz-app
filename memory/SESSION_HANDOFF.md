...
- **Port:** 8001 (internal)
- **URL:** https://blitz-dispatch.preview.emergentagent.com/api
...
```bash
# Backend API test
curl https://blitz-dispatch.preview.emergentagent.com/api/health

# Frontend test
curl https://blitz-dispatch.preview.emergentagent.com/
```
